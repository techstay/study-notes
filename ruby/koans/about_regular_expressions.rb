...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # The regex will try to match as long as possible
  ...
  #
  # Character class stands for a character(eg. 'a') or another character(eg. 'b')
  # Alternation stands for a string(eg 'abc') or another string(eg. 'bbc')
