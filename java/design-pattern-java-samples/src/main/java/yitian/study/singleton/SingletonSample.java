...
public class SingletonSample implements Sample {
    @Override
    public void run() {
        ...
        SynchronizedThreadSafeSingleton synchronizedThreadSafeSingleton = SynchronizedThreadSafeSingleton.getSingleton();
